...
const Home = () => {
  return (
    <SectionWrapper id="fixed-target" className="about">
      ...
      data-scroll-speed="-2">Vinyasa Flow</a>
      <img className="prod-one" src={img01} alt="Vinyasa Flow"  
      data-scroll  
      data-scroll-delay=".12"
      data-scroll-speed="-3" />
      ...
      data-scroll  
      data-scroll-delay=".12"
      data-scroll-speed="-2">Hatha Yoga</a>
      <img className="prod-two" src={img02} alt="Hatha Yoga"  
      data-scroll  
      data-scroll-delay=".12"
      data-scroll-speed="-3" />
